...
exports.postSignupinside = (req, res, next) => {
  ...
  User.findOne({ email: req.query.email }, (err, existingUser) => {
    ...
    const email = req.query.password;
...
exports.postUpdatePassword = (req, res, callback) => {
  ...
  Async.auto({
      ...
      hash: ['salt', function (results, done) {
          Bcrypt.hash(req.query.password, results.salt, done);
      }],
      start: function (done) {
        console.log("started")
      ...
      correctpwd: ['start', function (results, done) {
        console.log(req.query.passwordOld)
        console.log(req.query.password)
        console.log(JSON.parse(JSON.stringify(req.user)).password)
        Async.auto({
          ...
          console.log(results.start)
            console.log("old:"+req.query.passwordOld)
            console.log("New:"+req.query.password)
            console.log(JSON.parse(JSON.stringify(req.user)).password)
